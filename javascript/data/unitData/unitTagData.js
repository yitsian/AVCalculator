const unitTagData = {
  ...
  Hellkiller: { availability: ["Limited"], rarities: ["Exclusive"], elements: ["Unbound"], aoes: ["OCone"], mechanics: ["Ability"] },
  Callasuba: { availability: ["Limited"], rarities: ["Exclusive"], elements: ["Water"], aoes: ["Circle"], mechanics: ["Buffer", "CC", "Ability", "Nuke", "Summoner"] },
  Rideon: { availability: ["Limited"], rarities: ["Exclusive"], elements: ["Blast"], aoes: ["OCone"], mechanics: [] },
  Rummie: { availability: ["Limited"], rarities: ["Exclusive"], elements: ["Passion"], aoes: ["Circle"], mechanics: [] },
  Senator: { availability: ["Limited"], rarities: ["Exclusive"], elements: ["Fire"], aoes: ["Full"], mechanics: ["Immunity", "DOT"] },
  Lizard: { availability: ["Limited"], rarities: ["Exclusive"], elements: ["Spark"], aoes: ["Full"], mechanics: ["Ability", "DOT"] },
  GodAboveHeaven: { availability: ["Limited"], rarities: ["Secret"], elements: ["Holy"], aoes: ["Circle"], mechanics: ["Ability", "Domain", "CC"] },
  GodStandless: { availability: ["Limited"], rarities: ["Secret"], elements: ["Holy"], aoes: ["Circle"], mechanics: ["Ability", "CC", "Immunity", "Debuffer", "Summoner", "DOT"] },
  Cat: { availability: ["Limited"], rarities: ["Exclusive"], elements: ["Nature"], aoes: ["OCone"], mechanics: ["CC", "Debuffer", "DOT"] },
  Thunder: { availability: ["Limited"], rarities: ["Exclusive"], elements: ["Nature"], aoes: ["Circle"], mechanics: ["Summoner"] },
  Traitless: { availability: ["Limited"], rarities: ["Exclusive"], elements: ["Nature"], aoes: ["ACone"], mechanics: [] },
  ...
  GoblinKiller: { availability: ["Unobtainable"], rarities: ["Exclusive"], elements: ["Unbound"], aoes: ["Full"], mechanics: ["Debuffer"] },
  Priestess: { availability: ["Unobtainable"], rarities: ["Exclusive"], elements: ["Holy"], aoes: ["Line"], mechanics: ["CC"] },
  ...
  Slime: { availability: ["Unobtainable"], rarities: ["Secret"], elements: ["Water"], aoes: ["Full"], mechanics: ["Ability"] },
  ...
  Hebano: { availability: ["Unobtainable"], rarities: ["Exclusive"], elements: ["Fire"], aoes: ["Circle"], mechanics: ["DOT", "Buffer", "Debuffer"] },
  Marlin: { availability: ["Unobtainable"], rarities: ["Exclusive"], elements: ["Nature"], aoes: ["Circle"], mechanics: ["Ability", "Buffer", "Debuffer"] },
  Rudie: { availability: ["Unobtainable"], rarities: ["Exclusive"], elements: ["Water"], aoes: ["Full"], mechanics: ["Ability", "Meter", "Buffer", "Nuke"] },
